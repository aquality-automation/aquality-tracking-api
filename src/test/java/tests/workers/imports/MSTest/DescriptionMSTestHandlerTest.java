...
public class DescriptionMSTestHandlerTest {
    ...
    public void validateTests() throws JsonProcessingException {
        ...
        assertEquals(mapper.serialize(actualTests), FileUtils.getResourceFileAsString(getFilePath("testWithDescriptionName.json")));
    }
    ...
    private String getFilePath(String fileName) {
        return "reports/MSTest/".concat(fileName);
    }
}
