...
public class Step2TestDaoTest extends Step2TestDao implements IDaoTest {

    private String currentSql;
    private List<Pair<String, String>> currentParameters;
    private List<Step2TestDto> resultList;
    ...
    public void searchAllTest() throws AqualityException {
        resultList.add(new Step2TestDto());
        resultList.add(new Step2TestDto());
        List<Step2TestDto> result = searchAll(new Step2TestDto());
