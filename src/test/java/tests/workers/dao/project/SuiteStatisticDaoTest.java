...
public class SuiteStatisticDaoTest extends SuiteStatisticDao implements IDaoTest {
    ...
    @Test(expectedExceptions = AqualityException.class, expectedExceptionsMessageRegExp = "SQL procedure 'INSERT' is not define for DAO.+SuiteStatisticDao.+")
    public void insertTest() throws AqualityException {
        create(new SuiteStatisticDto());
    }

    @Test(expectedExceptions = AqualityException.class, expectedExceptionsMessageRegExp = "SQL procedure 'REMOVE' is not define for DAO.+SuiteStatisticDao.+")
