...
public class Suite2DashboardDaoTest extends Suite2DashboardDao implements IDaoTest {

    private String currentSql;
    private List<Pair<String, String>> currentParameters;
    private List<Suite2DashboardDto> resultList;
    ...
    public void searchAllTest() throws AqualityException {
        resultList.add(new Suite2DashboardDto());
        resultList.add(new Suite2DashboardDto());
        List<Suite2DashboardDto> result = searchAll(new Suite2DashboardDto());
    ...
    public void insertTest() throws AqualityException {
        resultList.add(new Suite2DashboardDto());
        create(new Suite2DashboardDto());
        assertSQLToParams(currentSql, currentParameters);
    }

    @Test
    public void removeTest() throws AqualityException {
        delete(new Suite2DashboardDto());
        assertSQLToParams(currentSql, currentParameters);
    }
