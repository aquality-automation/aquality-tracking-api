...
public class SuiteDashboardDaoTest extends SuiteDashboardDao implements IDaoTest {

    private String currentSql;
    private List<Pair<String, String>> currentParameters;
    private List<SuiteDashboardDto> resultList;
    ...
    public void searchAllTest() throws AqualityException {
        resultList.add(new SuiteDashboardDto());
        resultList.add(new SuiteDashboardDto());
        List<SuiteDashboardDto> result = searchAll(new SuiteDashboardDto());
    ...
    public void insertTest() throws AqualityException {
        resultList.add(new SuiteDashboardDto());
        create(new SuiteDashboardDto());
        assertSQLToParams(currentSql, currentParameters);
    }

    @Test
    public void removeTest() throws AqualityException {
        delete(new SuiteDashboardDto());
        assertSQLToParams(currentSql, currentParameters);
    }
