...
public class PredefinedResolutionDaoTest extends PredefinedResolutionDao implements IDaoTest {

    private String currentSql;
    private List<Pair<String, String>> currentParameters;
    private List<PredefinedResolutionDto> resultList;
    ...
    public void searchAllTest() throws AqualityException {
        resultList.add(new PredefinedResolutionDto());
        resultList.add(new PredefinedResolutionDto());
        List<PredefinedResolutionDto> result = searchAll(new PredefinedResolutionDto());
    ...
    public void insertTest() throws AqualityException {
        resultList.add(new PredefinedResolutionDto());
        create(new PredefinedResolutionDto());
        assertSQLToParams(currentSql, currentParameters);
    }

    @Test
    public void removeTest() throws AqualityException {
        delete(new PredefinedResolutionDto());
        assertSQLToParams(currentSql, currentParameters);
    }
