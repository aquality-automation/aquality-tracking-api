...
import main.model.db.dao.audit.AuditAttachmentsDao;
...
public class AuditAttachmentsDaoTest extends AuditAttachmentsDao {
    ...
    public void searchAllTest() throws AqualityException {
        ...
        resultList.add(new AuditAttachmentDto());
        List<AuditAttachmentDto> result = searchAll(new AuditAttachmentDto());
    ...
    public void insertTest() throws AqualityException {
        resultList.add(new AuditAttachmentDto());
        create(new AuditAttachmentDto());
        assertSQLToParams(currentSql, currentParameters);
    }

    @Test
    public void removeTest() throws AqualityException {
        delete(new AuditAttachmentDto());
        assertSQLToParams(currentSql, currentParameters);
    }
