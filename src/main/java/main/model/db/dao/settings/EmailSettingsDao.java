...
public class EmailSettingsDao extends DAO<EmailSettingsDto> {
    ...
    @Override
    public EmailSettingsDto create(EmailSettingsDto entity) throws RPException {
    ...
    public Integer isEmailsEnabled() throws RPException {
    ...
    private String hideAdminSecret(String secret) throws RPException {
        ...
        try {
            ...
            throw new RPException(String.format("Encoding Error: %s", e.getMessage()));
        }
    }
